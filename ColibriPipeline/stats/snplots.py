...
SNR plotting helpers. Relocated from the top-level ``snplots.py`` during the
module refactor (Wave 4). ``snplots.py`` is now a thin back-compat shim
re-exporting from here. Behaviour is unchanged.
"""
